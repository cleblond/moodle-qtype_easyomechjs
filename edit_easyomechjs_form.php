...
class qtype_easyomechjs_edit_form extends qtype_shortanswer_edit_form {
	...
	$marvinjspath = $marvinjsconfig->path;
        ...
        $mform->addElement('select', 'hideproducts',
                get_string('caseshowornoshowproducts', 'qtype_easyomechjs'), $menu);
        ...
        get_string('caseorderimportant', 'qtype_easyomechjs'), $menu);
        ...
        $mform->addElement('html', html_writer::tag('span', get_string('author', 'qtype_easyomechjs'),
        array('class' => 'easyomechjsauthor')));
	...
	$marvinpath = $marvinconfig->path;
        ...
        $PAGE->requires->js_init_call('M.qtype_easyomechjs.insert_applet', array($CFG->wwwroot, $marvinpath));


        $this->add_per_answer_fields($mform, get_string('answerno', 'qtype_easyomechjs', '{no}'),
                question_bank::fraction_options());

        $this->add_interactive_settings();
        $PAGE->requires->js_init_call('M.qtype_easyomechjs.init_getanswerstring', array($CFG->version));
    }
    ...
    protected function get_per_answer_fields($mform, $label, $gradeoptions,
        ...
        $insertbutton = $mform->createElement('button', 'insert', get_string('insertfromeditor', 'qtype_easyomechjs'), $scriptattrs);
